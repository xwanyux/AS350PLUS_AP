...
#define	ADDR_TERM_KSN			        ADDR_TERM_EPIN_DATA+250	  // b12,  2L-V, key serial number for DUKPT
#define ADDR_TERM_LANG_PREFER           ADDR_TERM_KSN+14          // an8,  2L-V (2*4 language preferences)
