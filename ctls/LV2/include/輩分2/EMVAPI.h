...
#define ADDR_ICC_DE_END                 ADDR_ICC_CH_LICENSE_TYPE+3
...
#define ADDR_CA_PK_AI                   ADDR_CA_HASH_AI+1
#define	ADDR_CA_PK_EXPIRY_DATE		    ADDR_CA_PK_AI+1		// 2011-03-16 for CUP
#define ADDR_CA_PK_RFU                  ADDR_CA_PK_EXPIRY_DATE+4
...
//      NOTE  : If RID..CSN = 00 00 00 00 00 00 00 00 00 -> end of list
//		              FF FF FF FF FF FF FF FF FF -> erased record
//	EMV   : at least 30 entries for each RID (16RID*30ENTRIIES = 480)
//----------------------------------------------------------------------------
#define MAX_CAPK_REVOC_CNT              100
...
#define ADDR_CAPK_REVOCATION_LIST_100	ADDR_CAPK_REVOCATION_LIST_01+CAPK_REVOC_LEN*(MAX_CAPK_REVOC_CNT-1)
...
//      Exception File
//
//      FORMAT: PAN[10] + PAN_SN[1]
//      NOTE  : If PAN[] = 00 00...00 -> end of list
//----------------------------------------------------------------------------
#define	MAX_EXCEPT_FILE_CNT		16
#define	EXCEPT_FILE_LEN			11

#define	ADDR_EXCEPT_FILE_01		ADDR_CAPK_REVOCATION_LIST_END
#define	ADDR_EXCEPT_FILE_02		ADDR_EXCEPT_FILE_01+EXCEPT_FILE_LEN*1
#define	ADDR_EXCEPT_FILE_16		ADDR_EXCEPT_FILE_01+EXCEPT_FILE_LEN*(MAX_EXCEPT_FILE_CNT-1)

#define	ADDR_EXCEPT_FILE_END		ADDR_EXCEPT_FILE_01+EXCEPT_FILE_LEN*MAX_EXCEPT_FILE_CNT
