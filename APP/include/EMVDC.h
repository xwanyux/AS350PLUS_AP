...
//      Function Table
//----------------------------------------------------------------------------
#define MAX_EMVDC_FUNC_CNT              21    // cf. EMVDC_Func_Table[cnt]
#define EMVDC_FUNC_LEN                  19      //     defined in XCONSTP1.C
#define EMVDC_ITEM_LEN                  18      //     defined in XCONSTP1.C

#define FN_SETUP_CONFIG                 0x00
#define FN_SET_DATE_TIME                0x01
#define FN_SET_DUKPT_KEY_TYPE           0x02
#define	FN_SET_ISO_FORMAT		        0x03
#define	FN_SET_KEY_INDEX		        0x04
#define FN_SET_MAC_KEY_INDEX            0X05
#define FN_SET_AID                      0x06
#define FN_SET_CONTRY_CODE              0x07
#define FN_SET_FLOOR_LIMIT              0x08
#define FN_SET_BRS_SHRESHOLD            0x09
#define FN_SET_BRS_MTP                  0x0A
#define FN_SET_RS_TP                    0x0B
#define FN_SET_TAC                      0x0C
#define FN_TRANS_LOG                    0x0D
#define FN_SETTLE                       0x0E
#define FN_LOAD_CAPK                    0x0F
#define FN_LOAD_PED_IKEY                0x10
#define FN_KERNEL_CHECKSUM              0x11
#define FN_SET_DDOL                     0x12
#define FN_SET_TDOL                     0x13
#define FN_GET_CAPK_INDEX               0x14
